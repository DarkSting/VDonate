...
return{width:{xs:'80%',lg:'30%',md:'40%'},
height:'50px',
...
export default function UserComplainTab(props){
    ...
    const handleSignUp = (arr)=>{
        ...
        const post = async(arr)=>{
           ...
           await Axios.post('/user/makeComplain', data).then(res=>{
            console.log(res)
...
<>
            {/*form holder*/}
                    ...
                    <TextBox id="outlined-multiline-flexible" label="Description" multiline maxRows={10} borderColor="red" HoverBorderColor={props.hover} onChange={(e)=>{
                        ...
                        {isDescNull!=true ?(<Typography variant="body2" sx={{color:'red', marginTop:"10px"}}>{descErr}</Typography>):
