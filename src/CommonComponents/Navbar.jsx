...
import { Mail, Notifications, Pets,Search as Srch, ArrowRight } from "@mui/icons-material";
  ...
  return (
    ...
    <NavBar position="sticky" props={props} sx={{marginTop:'0px',backgroundColor:props.color}}>
      ...
      >
        ...
        <MenuItem onClick={handleClose} sx={{'&:hover':{backgroundColor:props.color,color:'white'}}}>About</MenuItem>
        <MenuItem onClick={handleClose} sx={{'&:hover':{backgroundColor:props.color,color:'white'}}}>Home</MenuItem>
        <MenuItem onClick={()=>{
          navigate('/testPage');
        }} sx={{'&:hover':{backgroundColor:props.color,color:'white'}}}>Contact</MenuItem>
        <MenuItem onClick={()=>{
          navigate('/signup');
        } } sx={{'&:hover':{backgroundColor:props.color,color:'white'}}}>Sign Up</MenuItem>
      </Menu>
       ...
       <ButtonBox direction="row" props={props} >
            ...
            <NavButton onClick={()=>{navigate('/login')}} sx={{'&:hover':{backgroundColor:props.hoverColor}}}>
              Login
            </NavButton>
            <NavButton onClick={()=>{navigate('/testPage')}} sx={{'&:hover':{backgroundColor:props.hoverColor}}}>
              Contact
            </NavButton>
            <NavButton onClick={()=>{navigate('/signup')}} sx={{'&:hover':{backgroundColor:props.hoverColor}}}>
              Sign up
            </NavButton>
            <NavButton onClick={()=>{}} sx={{'&:hover':{backgroundColor:props.hoverColor}}}> 
              Why give Blood  
            </NavButton>
       </ButtonBox>
